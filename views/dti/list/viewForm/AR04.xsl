...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template name="DataArea">
    ...
    <xsl:call-template name="DataHeaderB01"/>
  </xsl:template>
  ...
  <!--  DTI Data Header 정보 보이기 Start -->
  <!--  위수탁 계산서 DTI Data Header 정보 보이기 Start -->
  <xsl:template name="DataHeaderB01">
    <!-- 변수 선언 시작 -->
    ...
    <div class="tax_invoice">
      ...
      <div class="tax_table" id="dtiTable" >


        <!--테이블헤더 start -->
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="dti_table01" class="tax_invoice01" summary="위수탁 전자계산서 승인번호, 관리번호">
          <caption>위수탁 전자계산서 승인번호, 관리번호</caption>
          <colgroup>
            <col width="41%"/>
            <col width="15%"/>
            <col width="5%"/>
          ...
          <tr>
            ...
            <th rowspan="2"  class="td2">
              ...
              <span id="dtiTableTitle">공 급 자</span><br />(보관용)
            </th>
            <td rowspan="2" id="dti_td" class="td4">
              <!--2013.11.27 : 수정세금계산서 당초승인번호 추가로 rowspan=2에서3으로 변경-->
              <xsl:if test="$HeaderDirPath/sb:OriginalIssueID">
                <xsl:attribute name="rowspan">
                  3
        ...
        <table id="dti_table02" class="tax_invoice02" border="0" cellspacing="0" cellpadding="0" width="100%" summary="공급자, 공급받는자 정보">
          <caption>
            공급자, 공급받는자 정보
          </caption>
          <colgroup>
        ...
        <!--공급가액 및 세액 start -->
        <table id="dti_table03" class="tax_invoice02" border="0" cellspacing="0" cellpadding="0" width="100%" summary="작성일자, 공급가액, 세액, 수정사유, 비고">
          ...
          <tr>
            ...
            <td class="tax_bold01" colspan="3">
              ...
              <xsl:value-of select="'-'"/>
              <xsl:value-of select="substring($BrokerPartyDirPath/sb:ID,4,2)"/>
              <xsl:value-of select="'-'"/>
              <xsl:value-of select="substring($BrokerPartyDirPath/sb:ID,6,5)"/>
            </td>
          </tr>
          <tr>
            <th>상호</th>
            <td>
              <xsl:value-of select="$BrokerPartyDirPath/sb:NameText"/>
            </td>
            <th>성명</th>
            <td>
              <xsl:value-of select="$BrokerPartyDirPath/sb:SpecifiedPerson/sb:NameText"/>
            </td>
          </tr>
          <tr>
            ...
            <td rowspan="2" class="cell_right01">
          ...
          <tr>
            <th>업태</th>
            <td>
              <xsl:value-of select="$BrokerPartyDirPath/sb:TypeCode"/>
            </td>
            <th>종목</th>
            <td>
              <xsl:value-of select="$BrokerPartyDirPath/sb:ClassificationCode"/>
            </td>
          </tr>
        </table>
        <!--//공급가액 및 세액 end -->
        ...
        <!-- 수정사유, 비고 start -->
        <table  id="dti_table06" class="tax_invoice02" border="0" cellspacing="0" cellpadding="0" width="100%" summary="수정사유, 비고 항목">
          <caption>
            수정사유, 비고 항목
          </caption>
          <colgroup>
        ...
        <!--품목별 단가 start -->
        <table id="dti_table04" class="tax_invoice02" border="0" cellspacing="0" cellpadding="0" width="100%" summary="월, 일, 품목, 규격, 수량, 단가, 공급가액, 세액, 비고">
        ...
        <!--합계 start -->
        <table id="dti_table05" class="tax_invoice02" border="0" cellspacing="0" cellpadding="0" width="100%" summary="합계금액, 현금, 수표, 어음, 외상미수금">
  ...
  <!--  위수탁 계산서 DTI Data Header 정보 보이기 End -->
  <!--  DTI Data Header 정보 보이기 Start -->
