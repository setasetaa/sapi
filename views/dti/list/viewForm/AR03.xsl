...
<xsl:stylesheet version="2.0"
  ...
  <!--  DTI Data Header 정보 보이기 Start -->
  <!--  위수탁 세금계산서 DTI Data Header 정보 보이기 Start -->
  <xsl:template name="DataHeaderB01">
    ...
    <div class="tax_invoice">
      ...
      <div class="tax_table" id="dtiTable">
        ...
        <!--테이블헤더 start -->
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="dti_table01" class="tax_invoice01" summary="위수탁 전자세금계산서 승인번호, 관리번호">
