...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template name="DataArea">
    ...
    <xsl:call-template name="DataHeader02"/>
  </xsl:template>
  <!--  DTI Data Area 정보 보이기 End -->


  <!--  DTI Data Header 정보 보이기 Start -->
  <!--  계산서 DTI Data Header 정보 보이기 Start -->
  <xsl:template name="DataHeader02">
    <!-- 변수 선언 시작 -->
    ...
    <div class="tax_invoice">
      ...
      <div class="tax_table" id="dtiTable">
        ...
        <table border="0" cellspacing="0" cellpadding="0"  width="100%"  id="dti_table01" class="tax_invoice01" summary="전자계산서 승인번호, 관리번호">
          <caption>전자계산서 승인번호, 관리번호</caption>
          <colgroup>
            <col width="41%"/>
            <col width="15%"/>
            <col width="5%"/>
  ...
  <!--  계산서 DTI Data Header 정보 보이기 End -->
