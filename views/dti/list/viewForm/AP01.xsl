  ...
  <xsl:template name="DataHeader01">
    ...
    <div class="tax_invoice">
      <div class="tax_table_Blue">
        ...
        <!--공급가액 및 세액 start -->
        <table class="tax_invoice02_Blue" border="0" cellspacing="0" cellpadding="0" summary="작성일자, 공급가액, 세액, 수정사유, 비고">
          <caption>
          ...
          <tbody>
            <tr>
              <th class="fontB_Blue td31">작성일자</th>
              <th class="fontB_Blue td31">공급가액</th>
              <th class="fontB_Blue td31">세 액</th>
              <th class="fontB_Blue td31">수정사유</th>
            </tr>
            <tr>
